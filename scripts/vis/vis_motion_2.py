...
h1_xml = "resources/robots/h1_2/h1_2.xml"
h1_urdf = "resources/robots/h1_2/urdf/h1_2.urdf"
asset_descriptors = [
...
motion_lib = MotionLibH1_2(motion_file=motion_file, device=device, masterfoot_conifg=None, fix_height=False, multi_thread=False, mjcf_file=h1_xml)
num_motions = 1
curr_start = 0
