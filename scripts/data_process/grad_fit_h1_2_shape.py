...
from phc.utils.torch_h1_2_humanoid_batch import Humanoid_Batch, H1_2_ROTATION_AXIS
...
pose_aa_h1 = torch.cat([torch.zeros((1, 1, 3)), H1_2_ROTATION_AXIS * dof_pos[..., None], torch.zeros((1, 2, 3))], axis = 1)
...
os.makedirs("data/h1_2", exist_ok=True)
joblib.dump((shape_new.detach(), scale), "data/h1_2/shape_optimized_v1.pkl") # V2 has hip jointsrea
print(f"shape fitted and saved to data/h1_2/shape_optimized_v1.pkl")